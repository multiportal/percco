              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="cate" name="cate">
                    <option value="Manufactura poliester" <?php echo $sel1=($cate=='Manufactura poliester') ? 'selected' : '';?>>Manufactura poliester</option>
                    <option value="Manufactura epoxicos" <?php echo $sel1=($cate=='Manufactura epoxicos') ? 'selected' : '';?>>Manufactura epoxicos</option>
                  </select>                  
                </div>
                <div class="form-group">
...
<div class="col-md-12">
        <?php 
		$query="SELECT * FROM ".$DBprefix."portafolio WHERE visible=1 ORDER BY ID ASC;";
