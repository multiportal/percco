...
.footer{background-color:#333;color:#fff;font-size:12px;font-weight:bold;text-align:center;padding:6px}
</style>
</head>
<body>
<div>
    <table class="fuente1" width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
      	<td colspan="6" class="dominio"><img src="'.$page_url.$path_tema.'images/'.$logo.'" alt="Logo" style="width:90px" />&nbsp;&nbsp;<a target="_blank" href="'.$page_url.'">www.phponix.webcindario.com</a></td>
      </tr>    
